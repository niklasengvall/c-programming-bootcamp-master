 ...
 *  - when the users enters 0, print the whole list of inputs and outputs
 * 
 * Bonus:
...
int main()
{
    ...
    printf("\n=== Working with Arrays: the right way! ===\n"); 

    int io_count = 0;
    const int max_io_count = 5;
    float io_array[max_io_count]; // Declares an array of 5 elements

    // Ask user about 5 values and store them into an array
